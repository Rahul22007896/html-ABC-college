...
<body>
    <header>
        <div class="container">
            <img src="download.png" alt="College Logo">
            <nav>
                <ul>
                    <li><a href="index.html">Home</a></li>
                    <li><a href="academics.html">Academics</a></li>
    ...
    <div class="container">
        <section>
            <h2>Academics</h2>
            <p>The Saveetha Engineering College has an excellent academic coordination methodology which has evolved over a period of more than 17 years and 
                has been producing excellent results in terms of students pass percentage and university ranks.
                The Following Courses Are Offered For Students Based On Flexi-Learn System 
            </p>
            <ul>
                <li>Science
                    <ul>
                ...
                <li>Commerce
                    <ul>
                        ...
                        <li><a href="business.html">Business Management</a></li>
                    </ul>
                </li>
            </ul>
        </section>
...
<body>
    ...
    <div class="container">
        <section>
            <h2>Gallery</h2>
            <div class="gallery">
                <img src="images.jpeg" alt="Gallery Image 1">
                <img src="clsroom.jpeg" alt="Gallery Image 2">
                <br>
                <img src="hall.jpeg" alt="Gallery Image 3">
                <img src="lib.jpeg" alt="Gallery Image 4">
            </div>
        </section>
    </div>
    <footer>
...
<body>
    <header>
        <div class="container">
            ...
            <p>Embark on a journey of innovation and excellence with the Department of Computer Science and Engineering, a cornerstone of academic prowess of Saveetha Engineering College since its inception in 2001. What began with an intake of 60 students has evolved into a dynamic hub of learning, now accommodating 240 bright minds by the year 2023-24. Our commitment to growth is evident in our consistent expansion, from 120 students in 2005-2006 to 180 in 2017-18.
